...
func NewGRPCServer(c *conf.Server, greeter *service.GreeterService, buffge *service.HelloworldService, logger log.Logger) *grpc.Server {
	...
	v2.RegisterHelloworldServer(srv, buffge)
	return srv
}
